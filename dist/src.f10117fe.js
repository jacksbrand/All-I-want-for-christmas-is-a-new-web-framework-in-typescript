...
function () {
  ...
  ApiSync.prototype.fetch = function (id) {
    return axios_1.default.get(this.rootUrl + "/users/" + id);
  };
...
/** @class */
function () {
  function Collection(rootUrl, deserialise) {
    this.rootUrl = rootUrl;
  ...
  Collection.prototype.fetch = function () {
    ...
    axios_1.default.get(this.rootUrl).then(function (response) {
      response.data.forEach(function (value) {
        _this.models.push(_this.deserialise(value));
      });
...
exports.User = User;
},{"./Attributes":"src/models/Attributes.ts","./ApiSync":"src/models/ApiSync.ts","./Eventing":"src/models/Eventing.ts","./Collection":"src/models/Collection.ts","./Model":"src/models/Model.ts"}],"src/views/View.ts":[function(require,module,exports) {
"use strict";
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "41215" + '/');
